...
export default function Home() {
  return (
    <section className=" bg-[#252b42] h-[1,132px] pt-20 pb-20 gap-20">
      ...
      <h1 className=" h-[160px] font-bold text-[58px] pb-28 text-white font-sans leading-[80px] tracking-wide">Selling on the <br />internet like a pro</h1>
